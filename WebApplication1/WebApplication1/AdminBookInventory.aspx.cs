    ...
    public partial class AdminBookInventory : System.Web.UI.Page
    {
        ...
        void updateBookByID()
        {
            ...
            if (checkIfBookExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("UPDATE book_master_tb1 set book_name=@book_name, genre=@genre, author_name=@author_name, publishar_name=@publishar_name, publish_date=@publish_date, language=@language, edition=@edition, book_cost=@book_cost, no_of_pages=@no_of_pages, book_description=@book_description, actual_stock=@actual_stock, current_stock=@current_stock, book_img_link=@book_img_link where book_id='" + TextBox1.Text.Trim() + "'", con);

                    cmd.Parameters.AddWithValue("@book_name", TextBox2.Text.Trim());
                    cmd.Parameters.AddWithValue("@genre", genres);
                    cmd.Parameters.AddWithValue("@author_name", DropDownList3.SelectedItem.Value);
                    cmd.Parameters.AddWithValue("@publishar_name", DropDownList2.SelectedItem.Value);
        ...
        void getBookByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    ...
                    DropDownList2.SelectedValue = dt.Rows[0]["publishar_name"].ToString().Trim();
        ...
        void fillAuthorPublisherValues()
        {
            try
            {
                ...
                cmd = new SqlCommand("SELECT publishar_name from publishar_master_tb1;", con);
                da = new SqlDataAdapter(cmd);
                dt = new DataTable();
                da.Fill(dt);
                DropDownList2.DataSource = dt;
                DropDownList2.DataValueField = "publishar_name";
